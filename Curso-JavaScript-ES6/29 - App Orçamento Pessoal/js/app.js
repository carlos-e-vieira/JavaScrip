...
class Bd {
	...
	// Function para gravar os dados
	gravar(d) {
		let id = this.getProximoId();

		// converte os dados em JSON = strings
	...
	recuperarTodosRegistro() {
		...
		for(let i = 1; i <= id; i++) {
			...
			// recuperar a despesa
			// converte os dados JSONpara Objeto literal
			let despesa = JSON.parse(localStorage.getItem(i));

			// pular itens que foram pulados ou removidos
			if (despesa === null) {
				continue
			} 
